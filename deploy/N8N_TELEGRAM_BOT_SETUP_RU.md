...
Гостевой чат на сайте использует **того же** консультанта через отдельный webhook-workflow — см. [N8N_GUEST_CHAT_SETUP_RU.md](N8N_GUEST_CHAT_SETUP_RU.md). n8n с телефона для ответов гостям не нужен.

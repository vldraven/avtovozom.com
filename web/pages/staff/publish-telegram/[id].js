...
const DEFAULT_AI_STYLE_HINT =
  "Сгенерируй продающее объявление для паблика в телеграм канале по доставке автомобилей из Китая, используй конечную цену в рублях, используй эмоджи для того, чтобы расставить акценты в тексте. Укажи, что указанная цена включает все расходы, доставку до города Москва и таможенное оформление, для расчета стоимости доставки в ваш город можно оставить заявку на расчет на сайте. Подробности по комплектации указаны на сайте.\n" +
  "Не используй фото в тексте.\n\n" +
  "Добавь абзац с описанием самой модели. Добавь тезис про попадание машины под льготный утилизационный сбор, это серьезная экономия при таможенном оформлении авто.\n" +
  "Укажи, что также вы можете подобрать авто и оставить заявку для связи с менеджером через нашего ИИ-агента: @avtovozombot";

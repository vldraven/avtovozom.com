...
const DEFAULT_AI_STYLE_HINT =
  "Сгенерируй объявление для паблика в телеграм канале по доставке автомобилей из Китая, используй конечную цену в рублях, используй эмоджи для того, чтобы расставить акценты в тексте. Укажи, что указанная цена включает все расходы и доставку до города Благовещенск или Владивосток, для расчета стоимости доставки в ваш город можно оставить заявку на расчет на сайте.\n\nДобавь небольшой абзац про описание самой модели.";

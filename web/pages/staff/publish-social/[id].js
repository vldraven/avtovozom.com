...
const DEFAULT_AI_STYLE_HINT =
  "Сгенерируй короткое яркое продающее объявление для паблика в телеграм канале по импорту авто из Китая, используй конечную цену в рублях с доставкой до мск, пиши человечно.\n\n" +
  "Добавь какой-нибудь интересный факт из интернета про эту модель, рубрика «А вы знали, что».\n\n" +
